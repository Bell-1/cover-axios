(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CoverAxios"] = factory();
	else
		root["CoverAxios"] = factory();
})(self, function() {
...
/* harmony export */ });
/* harmony import */ var _utils_path__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/path */ "./utils/path.js");
...
function genApi(apiName, url, method, meta) {
  var api = {
    apiName: apiName,
    method: method.toUpperCase(),
    url: (0,_utils_path__WEBPACK_IMPORTED_MODULE_0__.cleanPath)('/' + url)
  };
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CoverHTTP)
/* harmony export */ });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils_path__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/path */ "./utils/path.js");
...
var headers = localStorage.getItem('requestHeadersCache');

var noop = function noop() {};

var CoverHTTP = /*#__PURE__*/function () {
  function CoverHTTP(opts) {
    _classCallCheck(this, CoverHTTP);

    this.baseURL = '/';
    this.apiMap = {};
    this._headers = headers ? JSON.parse(headers) : {}; //headers

    var instance = this.instance = axios__WEBPACK_IMPORTED_MODULE_0___default().create(); // 初始化
  ...
  _createClass(CoverHTTP, [{
    ...
    function setHeaders(key, value) {
      ...
      localStorage.setItem('requestHeadersCache', JSON.stringify(_objectSpread({}, this._headers)));
      return this._headers;
    } // 移除请求头

  }, {
    key: "removeHeaders",
    value: function removeHeaders(key) {
      if (!key) return;
    ...
    key: "addApiList",
    value: function addApiList(apiList) {
    ...
    key: "beforeRequest",
    value: function beforeRequest(fn) {
    ...
    value: function request() {
      ...
      var pass = this.beforeRequestFn(api);
      ...
      return this.instance.request({
        ...
        headers: _objectSpread({}, this._headers)
      });
    }
  }]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "genApi": () => (/* reexport safe */ _lib_api__WEBPACK_IMPORTED_MODULE_1__.genApi),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _lib_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/http */ "./lib/http.js");
/* harmony import */ var _lib_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/api */ "./lib/api.js");


/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_lib_http__WEBPACK_IMPORTED_MODULE_0__.default);
})();
...
//# sourceMappingURL=cover-axios.js.map